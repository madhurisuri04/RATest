...
CREATE PROCEDURE dbo.spr_dbt_reconq
...
DELETE ' + @Client_DB + '.dbo.dbt_reconq
WHERE plan_id = (SELECT TOP 1 PLAN_ID FROM ' + @DBNAME + '.dbo.tbl_plan_name)

INSERT INTO ' + @Client_DB + '.dbo.dbt_reconq
EXEC ' + @DBNAME + '.dbo.spr_dbt_reconq
