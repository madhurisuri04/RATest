...
CREATE PROCEDURE dbo.spr_dbt_mm_ra_factor
...
DELETE ' + @Client_DB + '.dbo.dbt_mm_ra_factor
WHERE plan_id = (SELECT TOP 1 PLAN_ID FROM ' + @DBNAME + '.dbo.tbl_plan_name)

INSERT INTO ' + @Client_DB + '.dbo.dbt_mm_ra_factor
EXEC ' + @DBNAME + '.dbo.spr_dbt_mm_ra_factor
...
SELECT * FROM dbo.dbt_mm_ra_factor