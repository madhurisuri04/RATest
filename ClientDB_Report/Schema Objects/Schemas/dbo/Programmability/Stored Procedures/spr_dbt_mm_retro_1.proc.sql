...
CREATE PROCEDURE dbo.spr_dbt_mm_retro
...
DELETE ' + @Client_DB + '.dbo.dbt_mm_retro
WHERE plan_id = (SELECT TOP 1 PLAN_ID FROM ' + @DBNAME + '.dbo.tbl_plan_name)

INSERT INTO ' + @Client_DB + '.dbo.dbt_mm_retro
EXEC ' + @DBNAME + '.dbo.spr_dbt_mm_retro
