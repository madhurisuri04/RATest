...
CREATE PROCEDURE dbo.spr_dbt_hcc_prov_type
...
DELETE ' + @Client_DB + '.dbo.dbt_hcc_prov_type
WHERE plan_id = (SELECT TOP 1 PLAN_ID FROM ' + @DBNAME + '.dbo.tbl_plan_name)

INSERT INTO ' + @Client_DB + '.dbo.dbt_hcc_prov_type
EXEC ' + @DBNAME + '.dbo.spr_dbt_hcc_prov_type
...
SELECT * FROM dbo.dbt_hcc_prov_type