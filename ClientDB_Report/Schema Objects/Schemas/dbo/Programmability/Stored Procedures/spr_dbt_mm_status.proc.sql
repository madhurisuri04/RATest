...
CREATE PROCEDURE dbo.spr_dbt_mm_status
...
DELETE ' + @Client_DB + '.dbo.dbt_mm_status
WHERE plan_id = (SELECT TOP 1 PLAN_ID FROM ' + @DBNAME + '.dbo.tbl_plan_name)

INSERT INTO ' + @Client_DB + '.dbo.dbt_mm_status
EXEC ' + @DBNAME + '.dbo.spr_dbt_mm_status
