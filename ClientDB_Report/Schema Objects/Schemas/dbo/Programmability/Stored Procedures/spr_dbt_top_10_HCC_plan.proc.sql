...
CREATE PROCEDURE dbo.spr_dbt_top_10_HCC_plan
...
DELETE ' + @Client_DB + '.dbo.dbt_top_10_HCC_plan
WHERE plan_id = (SELECT TOP 1 PLAN_ID FROM ' + @DBNAME + '.dbo.tbl_plan_name)

INSERT INTO ' + @Client_DB + '.dbo.dbt_top_10_HCC_plan
EXEC ' + @DBNAME + '.dbo.spr_dbt_top_10_HCC_plan
...
SELECT * FROM dbo.dbt_top_10_HCC_plan