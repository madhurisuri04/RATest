...
CREATE PROCEDURE dbo.spr_dbt_top_10_HCC
...
DELETE ' + @Client_DB + '.dbo.dbt_top_10_HCC
WHERE plan_id = (SELECT TOP 1 PLAN_ID FROM ' + @DBNAME + '.dbo.tbl_plan_name)

INSERT INTO ' + @Client_DB + '.dbo.dbt_top_10_HCC
EXEC ' + @DBNAME + '.dbo.spr_dbt_top_10_HCC
...
SELECT * FROM dbo.dbt_top_10_HCC