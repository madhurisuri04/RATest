...
CREATE PROCEDURE dbo.spr_dbt_cn_qa
...
DELETE ' + @Client_DB + '.dbo.dbt_cn_qa

INSERT INTO ' + @Client_DB + '.dbo.dbt_cn_qa
EXEC ' + @DBNAME + '.dbo.spr_dbt_cn_qa
