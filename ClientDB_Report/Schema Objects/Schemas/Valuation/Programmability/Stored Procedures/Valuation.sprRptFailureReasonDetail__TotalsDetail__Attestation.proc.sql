CREATE PROCEDURE [Valuation].[sprRptFailureReasonDetail__TotalsDetail__Attestation]
	(
     @ClientId INT
...
/**************************************************************************************************** 
* Name			:	sprRptFailureReasonDetail__TotalsDetail__Attestation							*
* Type 			:	Stored Procedure																*
* Author       	:	Mitch Casto																		*
* Date			:	2016-03-23																		*
* Version			:																				*
* Description		: For Rpt Failure Reason Detail Attestation										*
*																									*
* Version History :																					*
* =================================================================================================	*
* Author			Date		Version#    TFS Ticket#	Description									*
* -----------------	----------  --------    -----------	------------								*
* David Waddell		2016-03-2	1.0			51835		Initial										*
*																									*
*****************************************************************************************************/ 
