CREATE PROCEDURE [Valuation].[spr_RptTotal_PMH_Attestation]
	(
     @ClientId INT
...
/******************************************************************************************** 
* Name			:	Valuation.spr_RptTotal_PMH_Attestation									*
* Type 			:	Stored Procedure														*
* Author       	:	D. Waddell																*
* Date			:	2016-04-05												     			*
* Version		:	1.0																		*
* Description	:	proc select record from the RptTotal table for  PMH_Attestation			*
*																							*
*																							*
* Version History	:																		*
* ===================																		*
...
* -----------------	----------  --------    -----------	------------						*
* DWaddell			2016-04-05  1.0			51835			Initial							*
*																							*
********************************************************************************************/
