CREATE PROC [Valuation].[sprRptPaymentDetail_BlendedPaymentDetailPartD] (@ClientId INT
                                                                  , @AutoProcessRunId INT
                                                                  , @ReportType VARCHAR(128)
                                                                  , @ReportSubType VARCHAR(128))
--
/**************************************************************************************************** 
* Name			:	[Valuation].[sprRptPaymentDetail_BlendedPaymentDetailPartD]    						*
...
AS
    SELECT DISTINCT [ReportType] = [pd].[ReportType]
                  ...
                  , [Header_A] = [pd].[Header_A]--EDS
                  , [Header_B] = [pd].[Header_B]--RAPS
