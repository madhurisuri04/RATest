CREATE PROCEDURE [Valuation].[spr_RptPaymentDetail_TotalDetail_PMH_Attestation]
	(
     @ClientId INT
...
/************************************************************************************ 
* Name			:	Valuation.spr_RptPaymentDetail__TotalsDetail__Attestation		*
* Type 			:	Stored Procedure												*
* Author       	:	D. Waddell													    *
* Date			:	2016-04-06												     	*
* Version		:	1.0																*
* Description	:	proc serves used for the Rpt Payment Detail Total				*
*					Detail_PMH_Attestation tabs										*
*																					*
*																					*
* Version History	:																*
* ===================																*
