...
CREATE TRIGGER [Valuation].[TR_ValuationRptSummaryTotalUnique] ON [Valuation].[RptSummaryTotalUnique]
...
AS
    BEGIN
        ...
        IF @Action IN ('I', 'U')
            BEGIN 
                ...
                INSERT  INTO [Valuation].[LogRptSummaryTotalUnique]
                        (
	[RptSummaryTotalUniqueId]
	,[ClientId] 
	,[ClientId_old]
	, [AutoProcessRunId]
   ...
   SELECT 
	[RptSummaryTotalUniqueId] = ISNULL(new.[RptSummaryTotalUniqueId], old.[RptSummaryTotalUniqueId])
	...
	, [IsSummary]= new.[IsSummary]
 	...
 	, [ReportBDate]= new.[ReportBDate]
   	, [ReportBDate_old] = old.[ReportBDate]
   	, [ReportEDate]= new.[ReportEDate]
	, [ReportEDate_old]=  old.[ReportEDate]
    ...
    , [Action] = @Action
                ...
                LEFT JOIN [Deleted] old
                    ON [new].[RptSummaryTotalUniqueId] = [old].[RptSummaryTotalUniqueId]
   ...
   SELECT 
    [RptSummaryTotalUniqueId] = old.[RptSummaryTotalUniqueId]  
	,[ClientId_old] = old.[ClientId]
	, [AutoProcessRunId_old] = old.[AutoProcessRunId] 
   	, [ReportHeader_old]= old.[ReportHeader] 
	, [RowDisplay_old] = old.[RowDisplay]
