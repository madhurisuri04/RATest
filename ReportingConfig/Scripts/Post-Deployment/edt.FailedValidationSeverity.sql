	...
	TRUNCATE TABLE [edt].[FailedValidationSeverity];
	GO
	
	SET IDENTITY_INSERT [edt].[FailedValidationSeverity] ON;
	
	INSERT INTO [edt].[FailedValidationSeverity] ([ID],[Name],[Descr])
        SELECT '1', 'Error', 'An error.'
    GO
	
	SET IDENTITY_INSERT [edt].[FailedValidationSeverity] OFF;
	...
	/*     EXEC [dbo].[GeneratePostDeploymentScript] 'edt', 'FailedValidationSeverity' */
