...
-- alter table [dbo].[lkRiskModelsFactors] add [SubmissionModel] [varchar](5) NOT NULL
...
delete from dbo.[lkRiskModelsFactors]
where PaymentYear = 2019
