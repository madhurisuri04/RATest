...
from
	AetIH_Report.dbo.RAPS_DiagHCC_Rollup r
...
drop table if exists ProdSupport.dbo.tbl_GAP_All_Diags_RAPS_PartC_AetIH

truncate table ProdSupport.dbo.tbl_GAP_All_Diags_RAPS_PartC_AetIH

insert into ProdSupport.dbo.tbl_GAP_All_Diags_RAPS_PartC_AetIH
select distinct 
	...
	m.PlanID
into ProdSupport.dbo.tbl_GAP_All_Diags_RAPS_PartC_AetIH
...
drop table if exists ProdSupport.dbo.tbl_GAP_All_Diags_RAPS_PartC_HCC_AetIH

truncate table ProdSupport.dbo.tbl_GAP_All_Diags_RAPS_PartC_HCC_AetIH

insert into ProdSupport.dbo.tbl_GAP_All_Diags_RAPS_PartC_HCC_AetIH
select distinct 
	PaymentYear, 
	HICN, 
	HCC, 
	...
	PlanID,
	RAFactorType
into ProdSupport.dbo.tbl_GAP_All_Diags_RAPS_PartC_HCC_AetIH
from 
...
UPDATE A
SET Hierarchy = 'L'
FROM ProdSupport.dbo.tbl_GAP_All_Diags_RAPS_PartC_HCC_AetIH A
WHERE 
	EXISTS
    (SELECT 1
		from ProdSupport.dbo.tbl_GAP_All_Diags_RAPS_PartC_AetIH B
...
into #HierHCC
from 
      ProdSupport.dbo.tbl_GAP_All_Diags_RAPS_PartC_HCC_AetIH a
      join ProdSupport.dbo.tbl_GAP_All_Diags_RAPS_PartC_AetIH b
