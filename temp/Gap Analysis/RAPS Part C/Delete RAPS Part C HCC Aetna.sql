...
drop table if exists ProdSupport.dbo.tbl_Delete_RAPS_DiagHCC_rollup_Aetna 

select * 
into 
	ProdSupport.dbo.tbl_Delete_RAPS_DiagHCC_rollup_Aetna
from 
...
set 
	...
	Deleted = 'D'
from 
ProdSupport.dbo.tbl_Delete_RAPS_DiagHCC_rollup_Aetna (nolock) b
...
drop table if exists ProdSupport.dbo.tbl_Delete_All_Diags_RAPS_PartC_Aetna
...
select distinct 
	...
	m.PlanID
into ProdSupport.dbo.tbl_Delete_All_Diags_RAPS_PartC_Aetna
...
select * from ProdSupport.dbo.tbl_Delete_All_Diags_RAPS_PartC_Aetna 

/**********************************************************************************
Find the list of HCC triggered by Deleted = D which do not exist elsewhere in the population
**********************************************************************************/

drop table ProdSupport.dbo.tbl_Delete_All_HCC_RAPS_PartC_Aetna
...
select distinct 
	...
	RAFactorType
into 
	ProdSupport.dbo.tbl_Delete_All_HCC_RAPS_PartC_Aetna
from 
	ProdSupport.dbo.tbl_Delete_All_Diags_RAPS_PartC_Aetna 
where 
	HCC is not null 
	and Deleted = 'D'
Except
...
select * from ProdSupport.dbo.tbl_Delete_All_Diags_RAPS_PartC_Aetna
select * from ProdSupport.dbo.tbl_Delete_All_HCC_RAPS_PartC_Aetna
...
UPDATE A
SET Hierarchy = 'L'
FROM ProdSupport.dbo.tbl_Delete_All_HCC_RAPS_PartC_Aetna A
WHERE EXISTS
    (SELECT 1
		from ProdSupport.dbo.tbl_Delete_All_Diags_RAPS_PartC_Aetna B
...
WHERE EXISTS
    (SELECT 1
		from ProdSupport.dbo.tbl_Delete_All_HCC_RAPS_PartC_Aetna B
		JOIN HRPReporting.dbo.lk_Risk_Models_Hierarchy C
            ON A.HICN = B.HICN
               AND B.HCC = C.HCC_KEEP
               AND A.HCC = C.HCC_DROP
...
into #HierHCC
from 
      ProdSupport.dbo.tbl_Delete_All_HCC_RAPS_PartC_Aetna a
      join ProdSupport.dbo.tbl_Delete_All_Diags_RAPS_PartC_Aetna b
...
drop table if exists ProdSupport.dbo.tbl_Delete_New_HCC_RAPS_PartC_Aetna
...
select distinct 
	...
	a.HeirHCC,
	RAFactorType
into ProdSupport.dbo.tbl_Delete_New_HCC_RAPS_PartC_Aetna
from
	ProdSupport.dbo.tbl_Delete_All_HCC_RAPS_PartC_Aetna a
Where
	a.Hierarchy is NULL or a.Hierarchy = 'H'

select * from ProdSupport.dbo.tbl_Delete_New_HCC_RAPS_PartC_Aetna