...
drop table if exists ProdSupport.dbo.tbl_GAP_All_Diags_RAPS_PartD_Aetna
...
-- truncate table ProdSupport.dbo.tbl_GAP_All_Diags_RAPS_PartD_Aetna

-- insert into ProdSupport.dbo.tbl_GAP_All_Diags_RAPS_PartD_Aetna
select distinct 
	...
	m.PlanID
into ProdSupport.dbo.tbl_GAP_All_Diags_RAPS_PartD_Aetna
...
drop table if exists ProdSupport.dbo.tbl_GAP_ALL_NEW_HCC_RAPS_PartD_Aetna

--truncate table ProdSupport.dbo.tbl_GAP_ALL_NEW_HCC_RAPS_PartD_Aetna

--insert into ProdSupport.dbo.tbl_GAP_ALL_NEW_HCC_RAPS_PartD_Aetna
select distinct 
	PaymentYear, 
	HICN, 
	HCC, 
	...
	PlanID,
	RAFactorType
into ProdSupport.dbo.tbl_GAP_ALL_NEW_HCC_RAPS_PartD_Aetna
from 
	ProdSupport.dbo.tbl_GAP_All_Diags_RAPS_PartD_Aetna
where 
	HCC is not null 
	and IsAdded = 'Y'
Except
...
UPDATE A
SET Hierarchy = 'L'
FROM ProdSupport.dbo.tbl_GAP_ALL_NEW_HCC_RAPS_PartD_Aetna A
WHERE 
	EXISTS
    (SELECT 1
		from ProdSupport.dbo.tbl_GAP_All_Diags_RAPS_PartD_Aetna B
...
WHERE 
	EXISTS
    (SELECT 1
		from ProdSupport.dbo.tbl_GAP_ALL_NEW_HCC_RAPS_PartD_Aetna B
		JOIN #lk_Risk_Models_Hierarchy C
            ON A.HICN = B.HICN
               AND B.HCC = C.HCC_KEEP
               AND A.HCC = C.HCC_DROP
...
into #HierHCC
from 
      ProdSupport.dbo.tbl_GAP_ALL_NEW_HCC_RAPS_PartD_Aetna a
      join ProdSupport.dbo.tbl_GAP_All_Diags_RAPS_PartD_Aetna b
...
drop table if exists ProdSupport.dbo.tbl_GAP_NEW_HCC_RAPS_PartD_Aetna
...
select distinct 
	...
	a.HCC, 
	a.HeirHCC
into ProdSupport.dbo.tbl_GAP_NEW_HCC_RAPS_PartD_Aetna
from
	ProdSupport.dbo.tbl_GAP_ALL_NEW_HCC_RAPS_PartD_Aetna a
Where
