...
creating tbl_Delete_RAPS_DiagHCC_rollup_Aetna is ignored for Part D as its already been done in Part C.
...
drop table if exists ProdSupport.dbo.tbl_Delete_All_Diags_RAPS_PartD_Aetna
...
select distinct 
	...
	m.PlanID
into ProdSupport.dbo.tbl_Delete_All_Diags_RAPS_PartD_Aetna
from ProdSupport.dbo.tbl_Delete_RAPS_DiagHCC_rollup_Aetna a
...
select * from ProdSupport.dbo.tbl_Delete_All_Diags_RAPS_PartD_Aetna 
...
drop table ProdSupport.dbo.tbl_Delete_All_HCC_RAPS_PartD_Aetna
...
select distinct 
	...
	RAFactorType
into 
	ProdSupport.dbo.tbl_Delete_All_HCC_RAPS_PartD_Aetna
from 
	ProdSupport.dbo.tbl_Delete_All_Diags_RAPS_PartD_Aetna 
where 
	HCC is not null 
	and Deleted = 'D'
Except
...
select * from ProdSupport.dbo.tbl_Delete_All_Diags_RAPS_PartD_Aetna
select * from ProdSupport.dbo.tbl_Delete_All_HCC_RAPS_PartD_Aetna
...
UPDATE A
SET Hierarchy = 'L'
FROM ProdSupport.dbo.tbl_Delete_All_HCC_RAPS_PartD_Aetna A
WHERE EXISTS
    (SELECT 1
		from ProdSupport.dbo.tbl_Delete_All_Diags_RAPS_PartD_Aetna B
...
WHERE EXISTS
    (SELECT 1
		from ProdSupport.dbo.tbl_Delete_All_HCC_RAPS_PartD_Aetna B
		JOIN #lk_Risk_Models_Hierarchy C
            ON A.HICN = B.HICN
               AND B.HCC = C.HCC_KEEP
               AND A.HCC = C.HCC_DROP
...
into #HierHCC
from 
      ProdSupport.dbo.tbl_Delete_All_HCC_RAPS_PartD_Aetna a
      join ProdSupport.dbo.tbl_Delete_All_Diags_RAPS_PartD_Aetna b
...
Final New HCC table - ProdSupport.dbo.tbl_GAP_NEW_HCC_RAPS_PartD_Aetna
**********************************************************************************/

drop table if exists ProdSupport.dbo.tbl_Delete_New_HCC_RAPS_PartD_Aetna
...
select distinct 
	...
	a.HeirHCC,
	RAFactorType
into ProdSupport.dbo.tbl_Delete_New_HCC_RAPS_PartD_Aetna
from
	ProdSupport.dbo.tbl_Delete_All_HCC_RAPS_PartD_Aetna a
Where
	a.Hierarchy is NULL or a.Hierarchy = 'H'

select * from ProdSupport.dbo.tbl_Delete_New_HCC_RAPS_PartD_Aetna