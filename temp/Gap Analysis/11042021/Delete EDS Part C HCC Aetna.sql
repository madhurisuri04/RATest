...
drop table if exists ProdSupport.dbo.tbl_Delete_EDS_DiagHCC_rollup_AetnaTest 

select * 
into 
	ProdSupport.dbo.tbl_Delete_EDS_DiagHCC_rollup_AetnaTest
from 
	ProdSupport.dbo.EDSSource_AetnaTest r
...
--select top 10 * from ProdSupport.dbo.tbl_Delete_EDS_DiagHCC_rollup_AetnaTest
--select top 10 * from ReportingETL.[HRP\hasan.farooqui].AETGapCheck_002d_RAPS_Source

insert into ProdSupport.dbo.tbl_Delete_EDS_DiagHCC_rollup_AetnaTest
(
	RunID ,
	LOB ,
	EncounterICN,
...
where 
	...
	and Accepted = 1
	and Deleted is null
	and exists (select 1 from ProdSupport.dbo.tbl_AetnaTest_GAP_Diags_Delete d where r.FinalHICN = d.HICN)
...
set 
	AddOrDeleteFlag = 'D'
from 
ProdSupport.dbo.tbl_Delete_EDS_DiagHCC_rollup_AetnaTest (nolock) b
...
from ProdSupport.dbo.tbl_Delete_EDS_DiagHCC_rollup_AetnaTest a
