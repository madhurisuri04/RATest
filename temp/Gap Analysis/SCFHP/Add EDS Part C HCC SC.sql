--drop table reportingETL.dbo.EDSSourceSC
select 
...
select * from reportingETL.dbo.EDSSourceSC
...
**********************************************************************************/
drop table if exists ReportingETL.dbo.tbl_GAP_All_Diags_EDS_PartC_SC
...
-- truncate table ReportingETL.dbo.tbl_GAP_All_Diags_EDS_PartC_SC

-- insert into ReportingETL.dbo.tbl_GAP_All_Diags_EDS_PartC_SC
select distinct 
	EncounterSource = 'EDS', 
	...
	m.PlanID
into ReportingETL.dbo.tbl_GAP_All_Diags_EDS_PartC_SC
from reportingETL.dbo.EDSSourceSC a
...
drop table if exists ReportingETL.dbo.tbl_GAP_ALL_NEW_HCC_EDS_PartC_SC

--truncate table ReportingETL.dbo.tbl_GAP_ALL_NEW_HCC_EDS_PartC_SC

--insert into ReportingETL.dbo.tbl_GAP_ALL_NEW_HCC_EDS_PartC_SC
select distinct 
	PaymentYear, 
	HICN, 
	HCC, 
	...
	PlanID,
	RAFactorType
into ReportingETL.dbo.tbl_GAP_ALL_NEW_HCC_EDS_PartC_SC
from 
	ReportingETL.dbo.tbl_GAP_All_Diags_EDS_PartC_SC
where 
	HCC is not null 
	and IsAdded = 'Y'
Except
...
UPDATE A
SET Hierarchy = 'L'
FROM ReportingETL.dbo.tbl_GAP_ALL_NEW_HCC_EDS_PartC_SC A
WHERE 
	EXISTS
    (SELECT 1
		from ReportingETL.dbo.tbl_GAP_All_Diags_EDS_PartC_SC B
...
WHERE 
	EXISTS
    (SELECT 1
		from ReportingETL.dbo.tbl_GAP_ALL_NEW_HCC_EDS_PartC_SC B
		JOIN HRPReporting.dbo.lk_Risk_Models_Hierarchy C
            ON A.HICN = B.HICN
               AND B.HCC = C.HCC_KEEP
               AND A.HCC = C.HCC_DROP
...
into #HierHCC
from 
      ReportingETL.dbo.tbl_GAP_ALL_NEW_HCC_EDS_PartC_SC a
      join ReportingETL.dbo.tbl_GAP_All_Diags_EDS_PartC_SC b
...
Final New HCC table - ReportingETL.dbo.tbl_GAP_NEW_HCC_EDS_PartC_SC
**********************************************************************************/

drop table if exists ReportingETL.dbo.tbl_GAP_NEW_HCC_EDS_PartC_SC
...
select distinct
	...
	a.HCC, 
	a.HeirHCC
into ReportingETL.dbo.tbl_GAP_NEW_HCC_EDS_PartC_SC
from
	ReportingETL.dbo.tbl_GAP_ALL_NEW_HCC_EDS_PartC_SC a
Where
...
drop table if exists #tbl_GAP_All_HCC_EDS_PartC_SC

select distinct PaymentYear, HICN, HCC, RAFactorType, IsAdded 
into #tbl_GAP_All_HCC_EDS_PartC_SC
from ReportingETL.dbo.tbl_GAP_All_Diags_EDS_PartC_SC
where HCC is not null

-- Interaction before Newly added HCC
drop table if exists #tbl_GAP_All_INT_EDS_PartC_SC
...
drop table if exists #tbl_GAP_NEW_INT_EDS_PartC_SC
...
select distinct
	...
	i.Interaction_Label HCC,
	a.RAFactorType
into #tbl_GAP_NEW_INT_EDS_PartC_SC
from 
	HRPReporting.dbo.lk_Risk_Models_Interactions i
	join #tbl_GAP_All_HCC_EDS_PartC_SC a
	on	a.RAFactorType = i.Factor_Type
...
**********************************************************************************/
insert into ReportingETL.dbo.tbl_GAP_NEW_HCC_EDS_PartC_SC
select Distinct
	PaymentYear,
	HICN,
	HCC,
...
from
(
select PaymentYear, HICN, HCC from #tbl_GAP_NEW_INT_EDS_PartC_SC
except
select PaymentYear, HICN, HCC from #tbl_GAP_All_INT_EDS_PartC_SC
) a
...
select * from ReportingETL.dbo.tbl_GAP_NEW_HCC_EDS_PartC_SC
