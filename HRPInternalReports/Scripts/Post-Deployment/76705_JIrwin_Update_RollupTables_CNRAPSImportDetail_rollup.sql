-- Add CNRAPSImportDetail to rollup process and associated config table entries
...
WITH [a1]
AS (
       SELECT [RollupTableName] = N'CNRAPSImportDetail_rollup'
            , [SourceTableName] = N'CNRAPSImportDetail'
            , [SourceTableSchema] = N'dbo'
            , [DateFieldForFilter] = N'IMPORTED_DATE'
            , [DateFieldForFilterType] = N'Day'
            , [ExecutionSequenceNumber] = N'26'
...
WHERE [a1].[RollupTableName] = 'CNRAPSImportDetail_rollup'
