-- Add RAPS_Detail_Import to rollup process and associated config table entries
...
WITH [a1]
AS (
       SELECT [RollupTableName] = N'RAPS_Detail_Import_rollup'
            , [SourceTableName] = N'RAPS_Detail_Import'
            , [SourceTableSchema] = N'dbo'
            , [DateFieldForFilter] = N'DATE_OF_SERVICE_START'
            , [DateFieldForFilterType] = N'Day'
            , [ExecutionSequenceNumber] = N'24'
...
WHERE [a1].[RollupTableName] = 'RAPS_Detail_Import_rollup'
